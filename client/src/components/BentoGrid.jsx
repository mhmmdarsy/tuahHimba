...
export default function BentoGrid({
  ...
  const columns = useMedia(
    ['(min-width:1280px)', '(min-width:1024px)', '(min-width:640px)', '(min-width:420px)'],
    [6, 4, 3, 2],
    1
  )
      ...
      {items.map((it, i) => {
        ...
        return (
          ...
          >
            ...
            >
              <div
                className={`w-full h-full bg-cover bg-center transition-transform duration-300 ${hoverScale !== 1 ? 'group-hover:scale-95' : ''}`}
