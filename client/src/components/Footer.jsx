  ...
  return (
    <footer id="tentang" className="bg-blue-950 text-white pt-6 pb-6">
      <div className="max-w-7xl mx-auto flex self-start text-left">
        <img
          src="/assets/images/lambang_kukar.png"
          alt="Museum Kayu"
          className="rounded-lg mr-6 self-start"
        ...
        <div>
          ...
          <div className="flex space-x-50">
            <div>
              ...
              <p className="mb-4">
                <a
                  href="mailto:diskominfo@mail.kukarkab.go.id"
            ...
            <div>
              ...
              <div className="flex space-x-20">
                <a
                  href="https://bapenda.kukarkab.go.id/"
                  target="_blank"
                  className="text-white hover:underline w-32 text-sm"
                  rel="noreferrer"
                >
                  Bapenda
                </a>
                <a
                  href="https://bappeda.kukarkab.go.id/"
                  target="_blank"
                  className="text-white hover:underline w-32 text-sm"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://disdikbud.kukarkab.go.id/"
                  target="_blank"
                  className="text-white hover:underline w-32 text-sm"
                  rel="noreferrer"
                >
              ...
              <div className="flex space-x-20 pt-2">
                ...
                <a
                  href="https://dpmptsp.kukarkab.go.id/"
                  target="_blank"
                  className="text-white hover:underline w-32 text-sm"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://prokom.kukarkab.go.id/"
                  target="_blank"
                  className="text-white hover:underline w-32 text-sm"
                  rel="noreferrer"
                >
